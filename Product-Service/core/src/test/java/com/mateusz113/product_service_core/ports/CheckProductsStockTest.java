...
public class CheckProductsStockTest {
    ...
    void checkStock_IncorrectIdsProvided_ThrowsProductDoesNotExistException() {
        ...
        ProductDoesNotExistException exception = assertThrows(ProductDoesNotExistException.class, () -> checkProductsStock.checkStock(productsStockMap));
    ...
    void checkStock_UnavailableAmountsProvided_ThrowsInvalidProductStockException() {
        ...
        InvalidProductStockException exception = assertThrows(InvalidProductStockException.class, () -> checkProductsStock.checkStock(productsStockMap));
    ...
    void checkStock_CorrectDataProvided_DoesNotThrowAnything() {
        ...
        assertDoesNotThrow(() -> checkProductsStock.checkStock(productsStockMap));
    }
